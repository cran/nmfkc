...
Looking at the diagnostics (the minimum ECV Sigma and the elbow of the R-squared curve; the green `eff.rank` line is shown for context), let's assume **Rank = 3** is a reasonable choice for this overview.
